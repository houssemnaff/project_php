...
INSERT INTO `produits` (`id_p`, `image`, `nom`, `prix`, `description`,`qte`) VALUES
(11, 'http://localhost/monoShop-main/image/image1.png', 'hp', 23, 'Un coloris mode et dynamique pour ces chaussures de sport Homme Adidas Runfalcon F36202 !\r\nCette basket running Adidas rouge combine tissu mesh respirant et matières synthétiques, avec les bandes Adidas blanches sur les côtés.',20);
...
INSERT INTO `admin` (`id`, `pseudo`, `email`, `motdepasse`) VALUES ('2', 'oussema ayari', 'oussemaayari@gmail.com', 'adminadmin');